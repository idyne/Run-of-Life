...
/* TCP_DATA u config(unity:"2020.2.1f1";ver:"2.6.0";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","CUSTOM_TIME","RIM","VERTEX_SIN_WAVES","DEPTH_VIEW_CORRECTION","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","TEMPLATE_LWRP","VSW_WORLDPOS"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Lighting"];shaderProperties:list[];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 2d175cbdf52728f2eac4e850fcdedfa2 */
