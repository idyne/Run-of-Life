...
Shader "Toony Colors Pro 2/User/Water Copy"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
...
/* TCP_DATA u config(unity:"2020.2.1f1";ver:"2.7.0";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","NO_FOAM_BACKFACE","SMOOTH_FOAM","FOAM_ANIM","VSW_FOLLOWNORM","VSW_WORLDPOS","DEPTH_VIEW_CORRECTION","DEPTH_BUFFER_FOAM","DEPTH_BUFFER_ALPHA","DEPTH_BUFFER_COLOR","TEMPLATE_LWRP","VERTEX_SIN_WAVES"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0"];shaderProperties:list[];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 9a22e805fcba7d56458866f7d1ae8a46 */
